...
export function BasicTab({ patient, onUpdate }: BasicTabProps) {
  ...
  const FieldWrapper = ({
    ...
    <div className="space-y-2">
      <Label htmlFor={label.toLowerCase().replace(/\s+/g, "_")} className="flex items-center gap-2">
      ...
      <Card>
        {!isEditing && (
          <CardHeader className="flex flex-row items-center justify-between">
            <h3 className="text-sm font-semibold">Basic Patient Info</h3>
          ...
          {isEditing ? (
            <div className="space-y-6">
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <FieldWrapper icon={RiCalendarLine} label="Registration Date">
                  <Input
                    id="created_at"
                ...
                <FieldWrapper icon={RiCalendarLine} label="Last Updated">
                  <Input
                    id="updated_at"
              ...
              <FieldWrapper icon={RiFileTextLine} label="Complaint">
                <Textarea
                  id="complaint"
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs text-gray-600 dark:text-gray-400">First Name</p>
              ...
              <div className="flex items-center gap-3">
                <RiUserLine className="size-5 text-gray-400" />
                <div>
                  <p className="text-xs text-gray-600 dark:text-gray-400">Last Name</p>
                  <p className="text-sm font-medium text-gray-900 dark:text-gray-50">
                    {patient.last_name || "—"}
                  </p>
                </div>
              ...
              {(patient as any).source && (
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium text-gray-900 dark:text-gray-50">
                      {(patient as any).source === "facebook"
                        ? "Facebook"
                        : (patient as any).source === "instagram"
                        ? "Instagram"
                        : (patient as any).source === "friend_recommendation"
                        ? "Friend Recommendation"
                        : (patient as any).source === "walk_in"
                        ? "Walk In"
                        : (patient as any).source === "other"
                        ? (patient as any).source_other || "Other"
                        : (patient as any).source}
                    </p>
                  </div>
                </div>
              ...
              {patient.complaint && (
                <div className="flex items-start gap-3 md:col-span-2">
                  <RiFileTextLine className="size-5 text-gray-400 mt-0.5" />
                  <div>
                    <p className="text-xs text-gray-600 dark:text-gray-400">Complaint</p>
                    <p className="text-sm font-medium text-gray-900 dark:text-gray-50">
                      {patient.complaint}
                    </p>
                  </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs text-gray-600 dark:text-gray-400">Registration Date</p>
                  <p className="text-sm font-medium text-gray-900 dark:text-gray-50">
